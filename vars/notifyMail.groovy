def call(String email_recipients = 'jenkins.OASIS@gmail.com', String message = 'Fear leads to anger. Anger leads to hate. Hate leads to suffering.') {
    ...
    emailext(subject: "Build $status - ${JOB_NAME} #${BUILD_NUMBER} ",
        body: """ <p> Hey mate! </p> <p> I just wanned to tell you that Build ${JOB_NAME} #${BUILD_NUMBER} has $status .You can find more information about the job under the following link:
        <a style = "font-size:14px;text-decoration:underline;font-weight:bold" href="${BUILD_URL}/console">${
            JOB_NAME
        } - build# ${BUILD_NUMBER} </a> And do not forget! You are awesome!</p>
