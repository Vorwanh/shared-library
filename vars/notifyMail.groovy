def call(String email_recipients = 'jenkins.OASIS@gmail.com', String message = 'Fear leads to anger. Anger leads to hate. Hate leads to suffering.') {
    ...
    emailext(subject: "Build $status - ${JOB_NAME} #${BUILD_NUMBER} ",
        body: """ <p> Hey mate! </p> <p> I just wanned to inform you about 2 things. </p> <p> First is that Build ${JOB_NAME} #${BUILD_NUMBER} has $status .</p> <p>You can find more information about the job under the following link: </p>
        <b><a style = "font-size:14px;text-decoration:underline;font-weight:bold" href="${BUILD_URL}/console">${
            JOB_NAME
        } - build# ${BUILD_NUMBER} </a> </b> </p> <p> Second one is that the shared libraries for notifications works well! Yuhuuuu! </p> <p> And one more thing...! </p> <p> <b> You are awesome! </b> </p>
